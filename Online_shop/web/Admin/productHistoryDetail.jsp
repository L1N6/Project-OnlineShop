                    ...
                    <tbody>
                        ...
                        <c:forEach items="${list}" var="h"> 
                            ...
                            <tr>
                                ...
                                <td>${h.historyProductDetailID}</td>  
                                <td>${h.employeeName}</td>  
                                <td>${h.status}</td>  
                                <td>${h.time}</td>  
                                <td>${h.productDetailID}</td>                                  
                                <td>${h.productStorage}</td>  
                                <td>${h.coler}</td>  
                                <td>${h.unitsInStock}</td>  
                                <td>${h.unitsOnOrder}</td>  
...
<script>
    $(document).ready(function () {
        ...
        var savedSearchValue = localStorage.getItem('searchValueProductDH');
        ...
        $('#startDate, #endDate').on('change', function () {
            ...
            localStorage.setItem('filterValuesProductDH', JSON.stringify(filterValues));
        ...
        $('#dataTable_filter input').on('keyup', function () {
            ...
            if (searchValue === '') {
                localStorage.removeItem('searchValueProductDH');
            } else {
                localStorage.setItem('searchValueProductDH', searchValue);
            }
        });
        ...
        $('#select-filter').on('change', function () {
            ...
            localStorage.setItem('filterValueProductDH', filterValue);
            table.column(2).search(filterValue).draw();
        });

        // Retrieve and apply saved filter values on page load
        var savedFilterValues = localStorage.getItem('filterValuesProductDH');
        ...
        var savedFilterValue = localStorage.getItem('filterValueProductDH');
