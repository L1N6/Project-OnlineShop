                                    ...
                                    <div >
                                        <div  class="product-item bg-light mb-4">
                                            ...
                                            <div class="product-action">
                                                ...
                                                <a class="btn btn-outline-dark btn-square" href="<c:url value="detail"/>"><i class="fa fa-search"></i></a>
                                            </div>
                                        </div>
                                        <div class="text-center py-4">
                                            <a class="h6 text-decoration-none text-truncate" href="<c:url value="detail">
                                                   <c:param name="productID" value="${p.getProductID()}" /> </c:url>">${p.productName}</a>
