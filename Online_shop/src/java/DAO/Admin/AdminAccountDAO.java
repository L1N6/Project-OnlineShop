...
public class AdminAccountDAO extends DBcontext {
        ...
        try {
            ...
            while (rs.next()) {
                if (rs.getInt("role") == 1) {
                    ...
                    acc = new Account(accountID, email, pass, employeeID, role, lastname, firstname);
                }else if(rs.getInt("role") == 3){
                    int accountID = rs.getInt("accountID");
                    acc = new Account(accountID, email, pass, accountID);
                }
            }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new AdminAccountDAO().getAccount("emp1@fpt.edu.vn", "123"));
    }
