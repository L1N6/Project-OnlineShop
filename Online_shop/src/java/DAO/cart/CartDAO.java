...
public class CartDAO extends DBcontext {
    ...
    public GuestProductCart getGProductCart(int ProductDetailID) throws SQLException {
        ...
        try {
            String sql = "select pd.ProductDetailID, pd.ProductID, p.ProductName, pd.Picture, pd.UnitPrice \n"
            ...
            while (rs.next()) {
                ...
                gProduct = new GuestProductCart(productDetailID, ProductName, Price, Picture);
            }
