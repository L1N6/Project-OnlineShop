...
<script>
                                    function changeStatus(employeeId, status, orderID) {
                                        ...
                                        if (status === 1) {
                                            change(employeeId, "Pending", "Cancelled", orderID);
                                        } else if (status === 2) {
                                            change(employeeId, "Pending", "Accepted", orderID);

                                        } else if (status === 0) {
                                            change(employeeId, "Accepted", "Cancelled", orderID);
                                        }

                                    }


                                    function change(employeeId, status1, status2, orderID) {


                                        var newStatus = prompt("Enter the new status (" + status1 + "  or " + status2 + "):");
                                        if (newStatus === status1 || newStatus === status2) {


                                            const data = {id: employeeId, status: newStatus, orderID: orderID};
                                            $.ajax({
                                                type: 'POST',
                                                url: "order",
                                                data: data,
                                            ...
                                            alert("Fail, please enter " + status1 + " or " + status2);
                                        }
                                    }
