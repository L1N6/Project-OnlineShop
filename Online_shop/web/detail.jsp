                    ...
                    <form>
                        <c:forEach items="${listColor}" var="color">
                            <span class="custom-control custom-radio custom-control-inline"> 
                                <input type="radio" class="custom-control-input" id="${color.getColor()}" name="color">
                                <label class="custom-control-label" for="${color.getColor()}">
                                    <c:out value="${color.getColor()}" /></label>
                            </span>
                        </c:forEach>
                    </form>
                </div>
